<html>
<body>
<head><center><h1> Quiz For Students</h1></center></head>
...
$n = 26; // this is the declaration of the total item on your quiz and array is used as a s9*torage of 	          //the question in order to display it in random
